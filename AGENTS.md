...
Operating manual for Codex in this repo. Read top-to-bottom before
...
VSBL/
  ...
  docs/
    ...
    CLAUDE_CODE_WORKFLOW.md            # how Codex works in this repo
    agents/, settings.json             # under .Codex/
  .Codex/
    settings.json
...
Loaded automatically by Codex from `.Codex/skills/`:
