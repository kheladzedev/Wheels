...
DEFAULT_REQUIRED_ARTIFACTS = [
    ...
    "src/data_readiness_decision.py",
    ...
    "outputs/production_audit/strict_dataset_real_v1_self_filter.json",
    "outputs/production_audit/strict_dataset_real_v1_self_plus_ue_synthetic_filter.json",
    "outputs/production_audit/threshold_conf070_real_val.json",
    "outputs/production_audit/threshold_conf075_real_val.json",
    "outputs/production_audit/threshold_conf080_real_val.json",
    "outputs/production_audit/operating_point_audit.json",
