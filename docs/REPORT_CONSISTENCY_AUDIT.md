...
| suite_release_count_matches_manifest | True | suite_release_artifacts=85, release_artifact_count=85 |
| objective_status_matches_suite | True | mismatches=[] |
| objective_completion_consistent | True | objective_complete=False, production_ready=False, failed_requirements=['production_evidence_present', 'production_gate_passed'] |
...
| handoff_bundle_verification_strict | True | verification_ok=True, required_artifact_count=24/24, entry_count=24, expected_entry_count=24, current_artifacts_ok=True, bundle_sha_match=True, bundle_size_match=True, missing_required=[], failures=[] |
