...
| champion_coreml_artifact | artifact | pass | False | True | `outputs/production_audit/coreml_export/best.mlmodel` | present |
| model_inventory_lineage | lineage | pass | True | True | `outputs/production_audit/model_inventory.json` | train_runs=13, artifacts=35, eval_reports=29, champion_run=True |
...
| dataset_format_and_leakage | data | pass | True | True | `outputs/production_audit/dataset_audit.json` | gate_ok=True, overall_ok=False, scope=configured_subset, failed_configs=[], missing_configs=[] |
| champion_real_validation_quality | model_quality | pass | True | True | `outputs/production_audit/operating_point_audit.json` | source=operating_point, report=outputs/production_audit/threshold_conf080_real_val.json, conf=0.800, bbox_mAP50=0.903>=0.850, OKS=0.888>=0.800, FN=0.094<=0.100, FP=0.147<=0.150 |
...
| coreml_certification | export | pass | False | True | `outputs/production_audit/coreml_certification.json` | certified=True, status=certified, artifact=outputs/production_audit/coreml_export/best.mlmodel |
...
| human_labelled_ar_device_holdout | production_validation | missing | False | True | `outputs/production_audit/ar_device_holdout_eval.json` | bbox_mAP50=0.000>=0.850, OKS=0.000>=0.800, FN=1.000<=0.100, FP=1.000<=0.150 |
